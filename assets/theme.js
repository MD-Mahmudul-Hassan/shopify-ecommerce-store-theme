...
theme.MobileNav = (function() {
  ...
  function goToSubnav(target) {
    ...
    cache.$pageContainer.css({
      transform: 'translateX(' + translateMenuHeight + 'px)'
    });
...
/*
* ========COLLECTON OVERLAY EFFECT ON HOVER =======================
*/
function hoverEffect(data) {  
  var prId = data.dataset.pid;
  var photo_fullsize = data.dataset.image;    
  if(prId){
    document.getElementById('img-'+prId).src = photo_fullsize;
  }
}

function relatedHoverEffect(data) {  
  var prId = data.dataset.pid;
  var photo_fullsize = data.dataset.image;    
  targetId = "img-ProductCardImage-product-recommendations-"+prId;  
  if(prId){
    document.getElementById(targetId).src = photo_fullsize
  }
}
